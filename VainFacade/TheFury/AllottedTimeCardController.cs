...
namespace VainFacadePlaytest.TheFury
{
    public class AllottedTimeCardController : TheFuryUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger((DealDamageAction dda) => !dda.IsPretend && dda.IsSuccessful && dda.CanDealDamage && dda.Amount > 0, MayProtectResponse, TriggerType.CreateStatusEffect, TriggerTiming.Before);
