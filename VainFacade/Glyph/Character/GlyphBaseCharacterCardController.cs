...
namespace VainFacadePlaytest.Glyph
{
    public class GlyphBaseCharacterCardController : HeroCharacterCardController
    {
        ...
        public override void AddStartOfGameTriggers()
        {
            ...
            if (this.TurnTakerController is GlyphTurnTakerController)
            {
        ...
        public override void AddTriggers()
        {
            ...
            //When you would play a card, you may play it face-down in any play area instead of resolving its normal effects.
            AddTrigger<PlayCardAction>((PlayCardAction pca) => pca.ResponsibleTurnTaker == this.TurnTaker && !pca.IsPutIntoPlay, PlayFaceDownInstead, TriggerType.MoveCard, TriggerTiming.Before);
