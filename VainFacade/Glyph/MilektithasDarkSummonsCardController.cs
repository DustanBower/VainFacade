...
namespace VainFacadePlaytest.Glyph
{
	public class MilektithasDarkSummonsCardController:GlyphCardUtilities
	{
        ...
        public override IEnumerator Play()
        {
            ...
            coroutine = SelectAndDestroyCardAndReturnLocation(DecisionMaker, new LinqCardCriteria(IsFaceDownDestruction, "face-down destruction"), true, destroyResults, locationResults, CustomDecisionMode.Destruction, cardSource: GetCardSource());
            if (base.UseUnityCoroutines)
            {
                yield return base.GameController.StartCoroutine(coroutine);
            }
