...
namespace VainFacadePlaytest.Glyph
{
	public class ReturnToSilenceCardController:GlyphCardUtilities
	{
        ...
        public override IEnumerator Play()
        {
            ...
            coroutine = SelectAndDestroyCardAndReturnLocation(DecisionMaker, new LinqCardCriteria(IsFaceDownDeath, "face-down death"), true, destroyResults, locationResults, CustomDecisionMode.Death, cardSource: GetCardSource());
            if (base.UseUnityCoroutines)
            {
                yield return base.GameController.StartCoroutine(coroutine);
            }
