...
namespace VainFacadePlaytest.Glyph
{
	public class InscrutableTutelageCardController:GlyphLimitedCard
	{
        ...
        public override IEnumerator Play()
        {
            ...
            new Function(base.HeroTurnTakerController, "Play a relic.", SelectionType.PlayCard,() => SelectAndPlayCardFromHand(DecisionMaker, cardCriteria: new LinqCardCriteria(IsRelic, "", false, false, "relic","relics")), this.HeroTurnTaker.Hand.Cards.Any((Card c) => IsRelic(c) && base.GameController.CanPlayCard(FindCardController(c)) == CanPlayCardResult.CanPlay))
            };
