...
namespace VainFacadePlaytest.Node
{
    public class PsychicLinkCardController : ConnectionCardController
    {
            ...
            : base(card, turnTakerController)
        {
            ...
            SpecialStringMaker.ShowSpecialString(() => "The top card of " + base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.GetFriendlyName() + " is " + base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.TopCard.Title + ". Its keywords are " + base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.TopCard.GetKeywords().ToCommaList(useWordAnd: true) + ".", showInEffectsList: () => base.Card.IsInPlayAndHasGameText).Condition = () => base.Card.IsInPlayAndHasGameText && base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.TopCard != null && base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.TopCard.GetKeywords().Count() > 1;
            SpecialStringMaker.ShowSpecialString(() => "The top card of " + base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.GetFriendlyName() + " is " + base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.TopCard.Title + ". Its only keyword is " + base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.TopCard.GetKeywords().ToCommaList(useWordAnd: true) + ".", showInEffectsList: () => base.Card.IsInPlayAndHasGameText).Condition = () => base.Card.IsInPlayAndHasGameText && base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.TopCard != null && base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.TopCard.GetKeywords().Count() == 1;
            SpecialStringMaker.ShowSpecialString(() => "The top card of " + base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.GetFriendlyName() + " is " + base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.TopCard.Title + ". It has no keywords.", showInEffectsList: () => base.Card.IsInPlayAndHasGameText).Condition = () => base.Card.IsInPlayAndHasGameText && base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.TopCard != null && base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.TopCard.GetKeywords().Count() == 0;
            SpecialStringMaker.ShowSpecialString(() => base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.GetFriendlyName() + " is empty.", showInEffectsList: () => base.Card.IsInPlayAndHasGameText).Condition = () => base.Card.IsInPlayAndHasGameText && base.Card.Location.HighestRecursiveLocation.OwnerTurnTaker.Deck.TopCard == null;
