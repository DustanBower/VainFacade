...
namespace VainFacadePlaytest.Blitz
{
    public class OffsidesCardController : CardController
    {
            ...
            : base(card, turnTakerController)
        {
            ...
            SpecialStringMaker.ShowListOfCardsAtLocation(base.TurnTaker.PlayArea, new LinqCardCriteria((Card c) => !c.IsCharacter && !IsVillain(c), "non-character non-villain"));
        }
