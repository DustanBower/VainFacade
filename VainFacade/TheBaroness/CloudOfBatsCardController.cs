...
namespace VainFacadePlaytest.TheBaroness
{
    public class CloudOfBatsCardController : BaronessUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger((MoveCardAction mca) => mca.CardToMove.Owner == base.TurnTaker && mca.CardToMove.Identifier == BatIdentifier && !(mca.Destination.IsInPlay && mca.Destination.HighestRecursiveLocation == this.TurnTaker.PlayArea) && !mca.Destination.IsOffToTheSide, (MoveCardAction mca) => CancelAction(mca), TriggerType.CancelAction, TriggerTiming.Before);
