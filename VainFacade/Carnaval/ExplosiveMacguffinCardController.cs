...
namespace VainFacadePlaytest.Carnaval
{
    public class ExplosiveMacguffinCardController : CardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger((MoveCardAction mca) => mca.IsDiscard && mca.CardToMove.IsHero && (GameController.ActiveTurnTaker.IsEnvironment || GameController.ActiveTurnTaker.IsVillain), ExplodeResponse, new TriggerType[] { TriggerType.DealDamage, TriggerType.DestroyCard }, TriggerTiming.After);
        }
