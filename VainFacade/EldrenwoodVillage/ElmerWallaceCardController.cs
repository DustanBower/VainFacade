...
namespace VainFacadePlaytest.EldrenwoodVillage
{
    public class ElmerWallaceCardController : AfflictedCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddEndOfTurnTrigger((TurnTaker tt) => tt == base.TurnTaker && !CanActivateEffect(base.TurnTakerController, HowlsKey), (PhaseChangeAction pca) => GameController.SelectHeroToDrawCard(DecisionMaker, optionalDrawCard: false, cardSource: GetCardSource()), TriggerType.DrawCard);
        }
