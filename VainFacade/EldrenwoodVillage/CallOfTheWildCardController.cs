...
namespace VainFacadePlaytest.EldrenwoodVillage
{
    public class CallOfTheWildCardController : EldrenwoodUtilityCardController
    {
            ...
            : base(card, turnTakerController)
        {
            ...
            SpecialStringMaker.ShowNumberOfCardsInPlay(new LinqCardCriteria((Card c) => c.DoKeywordsContain(WerewolfKeyword), "Werewolf"));
        ...
        public override bool AskIfCardIsIndestructible(Card card)
        {
            if (card.DoKeywordsContain(TriggerKeyword))
            {
                ...
                return FindCardsWhere(new LinqCardCriteria((Card c) => c.IsInPlayAndNotUnderCard && c.DoKeywordsContain(WerewolfKeyword), "in play", false, true, "Werewolf card", "Werewolf cards"), visibleToCard: GetCardSource()).Count() > 0;
            }
        ...
        public override void AddTriggers()
        {
            ...
            AddIncreaseDamageTrigger((DealDamageAction dda) => dda.DamageSource != null && dda.DamageSource.IsCard && dda.DamageSource.Card.DoKeywordsContain(WerewolfKeyword), 1);
