...
namespace VainFacadePlaytest.EldrenwoodVillage
{
    public class OlPegSimmonsCardController : AfflictedCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddEndOfTurnTrigger((TurnTaker tt) => tt == base.TurnTaker && CanActivateEffect(base.Card, QuaintKey), OnePlayerDraw2Discard1Response, new TriggerType[] { TriggerType.DrawCard, TriggerType.DiscardCard });
            // ...
        }
