...
namespace VainFacadePlaytest.EldrenwoodVillage
{
    public class SamRichardsCardController : AfflictedCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddEndOfTurnTrigger((TurnTaker tt) => tt == base.TurnTaker && CanActivateEffect(base.Card, QuaintKey), SelectPlayerCheckResultsResponse, new TriggerType[] { TriggerType.DiscardCard, TriggerType.PlayCard, TriggerType.DealDamage });
        }
