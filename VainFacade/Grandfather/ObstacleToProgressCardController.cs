...
namespace VainFacadePlaytest.Grandfather
{
    public class ObstacleToProgressCardController : CardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger((DealDamageAction dda) => GetCardThisCardIsNextTo() != null && GetCardThisCardIsNextTo().IsTarget && dda.DamageSource != null && dda.DamageSource.IsCard && IsVillain(dda.DamageSource.Card) && !IsPropertyTrue(GeneratePerTargetKey(FirstDamage, dda.DamageSource.Card)), RedirectDamageResponse, TriggerType.RedirectDamage, TriggerTiming.Before);
        ...
        public override IEnumerator DeterminePlayLocation(List<MoveCardDestination> storedResults, bool isPutIntoPlay, List<IDecision> decisionSources, Location overridePlayArea = null, LinqTurnTakerCriteria additionalTurnTakerCriteria = null)
        {
            ...
            IEnumerator findCoroutine = base.GameController.FindTargetWithHighestHitPoints(1, (Card c) => IsHeroCharacterCard(c), found, evenIfCannotDealDamage: true, cardSource: GetCardSource());
