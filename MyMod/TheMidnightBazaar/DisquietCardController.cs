...
namespace VainFacade.TheMidnightBazaar
{
    public class DisquietCardController : TheMidnightBazaarUtilityCardController
    {
        ...
        public override void AddTriggers()
        {
            ...
            AddTrigger((DealDamageAction dda) => dda.DamageSource != null && dda.DamageSource.Card != null && IsThreen(dda.DamageSource.Card), MoveCardsToRedirectResponse, new TriggerType[] { TriggerType.MoveCard, TriggerType.RedirectDamage }, TriggerTiming.Before);
        }
